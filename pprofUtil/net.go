...
var _Default = http.NewServeMux()
var _DefaultHttp *http.Server
...
func StartPprof(addr string, waitObj *sync.WaitGroup) {
	defer waitObj.Done()

	SetMux(_Default)
	_DefaultHttp = &http.Server{Addr: addr, Handler: _Default}
	_DefaultHttp.ListenAndServe()
}
